...
try
{
    ...
    *ppRetVal = nullptr;
    ...
    if (_searcher.IsStale(*_pData, queryText, ignoreCase ? SearchFlag::CaseInsensitive : SearchFlag{}))
    {
        _searcher.Reset(*_pData, queryText, ignoreCase ? SearchFlag::CaseInsensitive : SearchFlag{}, searchBackward);
    }
